...
% A fork of unofficial University of Lethbridge Poster template: 
...
\institute[shortinst]{University of Liverpool}
...
Poster Session \hfill
  \href{mailto:youremail@ualberta.ca}{youremail@liverpool.ac.uk}}
...
% Left: institution
 \logoleft{\hspace*{5cm}\includegraphics[height=5cm]{logos/UoL_Logo_white.png}}
...
\begin{column}{\colwidth}
  ...
  \begin{block}{References}
    ...
    \nocite{*}
    \footnotesize{\bibliographystyle{IEEEtran}\bibliography{poster}}
